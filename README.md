...
You can store your books information into this application. 
There are three book shelf for you to select for each book, which named 'currently reading', 'want to read' and 'read'.
You can search book in the retrieval page and add the book in the bookshelf.

## How to use?

Clone this to your local and run `npm install`.
Find the file `puc` and open the `index.html` file.  